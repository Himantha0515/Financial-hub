...
// Updated CTA strip with Indian app store references
export const CTAStrip: React.FC = () => {
  return (
    <motion.div
      ...
      className="fixed bottom-16 md:bottom-0 left-0 right-0 bg-light-surface/95 dark:bg-dark-surface/95 backdrop-blur-glass border-t border-light-border dark:border-dark-border p-4 z-30 transition-colors duration-300"
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          ...
          >
            Manage smarter. Invest globally.
          </motion.h3>
          ...
          >
            ...
            <span className="text-sm text-light-text-secondary dark:text-dark-text-secondary">Google Play & App Store</span>
          </motion.div>
        </div>
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="hidden md:flex items-center space-x-2 bg-light-glass dark:bg-dark-glass border border-light-border dark:border-dark-border px-4 py-2 rounded-xl hover:border-lime-accent/30 transition-all duration-300"
          >
